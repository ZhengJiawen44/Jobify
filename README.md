    ...
    <Wrapper>
      ...
      <div className="container page">
        ...
        <div className="info">
          ...
          <p>
            Lorem dipshit I'm baby wayfarers hoodie next level taiyaki brooklyn
...
authControllers.js
https://codetofun.com/express/res/cookie/
...
#### All Jobs - cuz fuck that Structure

AllJobs -> JobsContainer -> Job -> JobInfo'
...
const Job = ({ Position, company, location, date, type, status }) => {
  return (
    <Wrapper>
      <header>
        <div className="main-icon">O</div>
        <div className="info">
          <h5>{Position}</h5>
          <p>{company}</p>
        </div>
